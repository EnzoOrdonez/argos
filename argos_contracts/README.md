...
Shared Pydantic v2 models that cross team boundaries in ARGOS. Implementing this module first (Week 2, before any layer-specific code) is contracts-first development: it locks the interfaces between layers so P1 (LLM/SOAR), P2 (ML), P3 (Detection), and P4 (Infra/UI) can implement their layers in parallel without integration friction in Weeks 7-9.
